...
function fallbackFaq(s: RateSettings): FaqItem[] {
  return [
    ...
    },
    {
      ...
      answer:
        'Дорога из Москвы занимает около пяти часов, из Санкт-Петербурга — около четырех. Усадьба находится в Новосокольническом районе Псковской области.',
    },
    {
      question: 'Что включено в стоимость аренды?',
      answer:
        'В стоимость входит аренда дома целиком, оборудованная кухня, Wi-Fi, постельное белье и полотенца. После 8 гостей доплата составляет 1 650 ₽ за каждого гостя за ночь; баня и чан стоят 7 700 ₽ за топку; лодка и сап-борды оплачиваются отдельно, стоимость уточняется при бронировании.',
    },
    {

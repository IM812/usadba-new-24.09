...
function fallbackFaq(s: RateSettings): FaqItem[] {
  return [
    ...
    },
    {
      ...
      answer:
        'В стоимость входит аренда дома целиком, оборудованная кухня, Wi-Fi, постельное белье и полотенца. После 8 гостей доплата составляет 1 650 ₽ за каждого гостя за ночь; баня и чан стоят 7 700 ₽ за топку; лодка и сапы входят в стоимость проживания.',
    },
    {

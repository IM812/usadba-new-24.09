...
export const galleryPhotos = [
  ...
  { category: 'house', src: '/images/drive/living/living-room.webp', alt: 'Просторная гостиная бревенчатого дома', caption: 'Просторная гостиная' },
  { category: 'house', src: '/images/drive/kitchen/kitchen-corner.webp', alt: 'Рабочая зона кухни в усадьбе', caption: 'Рабочая зона кухни' },
  { category: 'house', src: '/images/drive/dining/feast.webp', alt: 'Ужин за большим деревянным столом', caption: 'Большой обеденный стол' },
  ...
  { category: 'house', src: '/images/drive/dining/piano-window.webp', alt: 'Пианино у окна в столовой', caption: 'Пианино в общей комнате' },
  { category: 'house', src: '/images/drive/kitchen/copper-details.webp', alt: 'Медная посуда на кухне', caption: 'Медная посуда на кухне' },
  { category: 'house', src: '/images/drive/entry/entry-table.webp', alt: 'Консольный стол в прихожей', caption: 'Консоль в прихожей' },
  ...
  { category: 'house', src: '/images/drive/kitchen/kitchen-window.webp', alt: 'Кухня с окном в лес', caption: 'Кухня с видом на лес' },
  ...
  { category: 'bedrooms', src: '/images/drive/bedrooms/bedroom-warm.webp', alt: 'Уютная спальня в бревенчатом доме', caption: 'Спальня в деревянном доме' },
  ...
  { category: 'spa', src: '/images/drive/spa/hot-tub-lake.webp', alt: 'Сибирский чан с видом на лесное озеро', caption: 'Чан у озера' },
  ...
  { category: 'spa', src: '/images/drive/spa/sauna.webp', alt: 'Деревянная парная бани', caption: 'Дровяная парная' },
  ...
  { category: 'spa', src: '/images/drive/spa/hot-tub-winter.webp', alt: 'Сибирский чан среди заснеженных сосен', caption: 'Чан зимой' },
  ...
  { category: 'spa', src: '/images/drive/spa/sauna-details.webp', alt: 'Детали интерьера бани', caption: 'Интерьер бани' },
  { category: 'grounds', src: '/images/drive/grounds/guests-pier.webp', alt: 'Отдых гостей на причале у озера', caption: 'Отдых на причале' },
  ...
  { category: 'grounds', src: '/images/drive/grounds/pond-evening.webp', alt: 'Вечер у воды рядом с домом', caption: 'Вечер у воды' },
  ...
  { category: 'grounds', src: '/images/drive/grounds/lake-mist.webp', alt: 'Утренний туман над озером', caption: 'Утро на берегу озера' },

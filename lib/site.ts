...
export const rooms = [
  ...
  },
  {
    ...
    description:
      'В доме четыре отдельные спальни. Мы не придумываем им названия: показываем реальные комнаты и подтверждаем подходящую схему размещения под состав вашей компании до бронирования.',
...
export const galleryPhotos = [
  ...
  },
  {
    ...
    caption: 'Одна из четырёх спален усадьбы',
  },
  {

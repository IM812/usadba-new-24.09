...
export const galleryPhotos = [
  ...
  { category: 'house', src: '/images/drive/house/house-by-lake.webp', alt: 'Дом рядом с лесным озером', caption: 'Дом в нескольких шагах от воды' },
  { category: 'house', src: '/images/drive/house/house-lights.webp', alt: 'Усадьба с вечерней подсветкой', caption: 'Вечерний свет среди сосен' },
  { category: 'house', src: '/images/drive/house/house-winter-night.webp', alt: 'Дом зимней ночью', caption: 'Тёплый дом в заснеженном лесу' },
  { category: 'house', src: '/images/drive/house/terrace-chairs.webp', alt: 'Кресла на террасе деревянного дома', caption: 'Место для отдыха на свежем воздухе' },
  { category: 'house', src: '/images/drive/kitchen/kitchen-window.webp', alt: 'Кухня с окном в лес', caption: 'Светлая кухня с видом на сосны' },
  { category: 'house', src: '/images/drive/living/reading-lamp.webp', alt: 'Уголок для чтения в гостиной', caption: 'Тихое место для книги и отдыха' },
  { category: 'house', src: '/images/drive/entry/entry-door.webp', alt: 'Вход в бревенчатый дом', caption: 'Тёплые детали загородного дома' },
  ...
  { category: 'spa', src: '/images/drive/spa/hot-tub-shore.webp', alt: 'Сибирский чан с огнём у берега озера', caption: 'Огонь, горячая вода и озеро перед глазами' },
  ...
  { category: 'spa', src: '/images/drive/spa/hot-tub-steps.webp', alt: 'Дровяной чан среди деревьев', caption: 'Настоящий дровяной чан у самого берега' },
  ...
  { category: 'spa', src: '/images/drive/house/house-hot-tub.webp', alt: 'Чан рядом с домом и озером', caption: 'Чан рядом с домом и берегом' },
  ...
  { category: 'grounds', src: '/images/drive/grounds/guests-pier.webp', alt: 'Отдых гостей на причале у озера', caption: 'Тихий вечер на собственном причале' },
  ...
  { category: 'grounds', src: '/images/drive/grounds/pond-evening.webp', alt: 'Вечер у воды рядом с домом', caption: 'Отражения вечерних огней на воде' },
  { category: 'grounds', src: '/images/drive/grounds/rainbow-lake.webp', alt: 'Радуга над лесным озером', caption: 'Озеро после дождя' },
  ...
  { category: 'grounds', src: '/images/drive/grounds/lake-mist.webp', alt: 'Утренний туман над озером', caption: 'Тихое утро на собственном берегу' },
  ...
  { category: 'grounds', src: '/images/drive/grounds/lake-chair.webp', alt: 'Место для рыбалки у озера', caption: 'Рыбалка и отдых прямо с причала' },
  ...
  { category: 'grounds', src: '/images/drive/grounds/winter-lights.webp', alt: 'Зимняя подсветка дома и леса', caption: 'Зимний вечер среди подсвеченных сосен' },

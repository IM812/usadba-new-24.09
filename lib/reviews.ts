...
export const fallbackReviews: GuestReview[] = [
  {
    ...
    date: 'Август 2026',
    rating: 5,
    text: 'Замечательное место для тихого отдыха на природе. В доме уютно, чисто и есть всё необходимое, а вокруг — лес, озеро и много пространства для прогулок. Особенно понравились тишина, красивая территория и возможность провести несколько дней вдали от города.',
  },
  {

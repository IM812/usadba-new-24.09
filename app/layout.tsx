...
export const metadata: Metadata = {
  ...
  description:
    'Частная бревенчатая усадьба 250 м² между двумя озёрами в Псковской области. Баня на дровах, сибирский чан, причал, лодка и сап-борды. Отзывы гостей на Яндекс Картах. 5 часов от Москвы.',
  keywords: [
    'усадьба Антропково',

...
const chapters: {
  ...
  },
  {
    ...
    focus: "object-top",
    line: "Два озера, свой причал и сосновый лес за домом. Лодка и сапы входят в стоимость проживания.",
  },
]

// Время заезда для микроразметки берется из настроек — обновляем раз в 5 минут.
          ...
          <div data-reveal className="grid gap-8 min-[390px]:gap-10 lg:grid-cols-[1fr_1.1fr] lg:items-center lg:gap-24">
            <div className="relative">
              ...
              <p className="mt-6 max-w-xs text-[13px] leading-relaxed text-muted-foreground">
                Открытая терраса с видом на озеро — место для утреннего кофе, неспешного ужина и
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex max-w-xl flex-col gap-5 text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
                <p>
                  Усадьба находится между двумя озерами, в сосновом бору Новосокольнического района.
                  Рядом — собственный пляж и причал, а вокруг дома — лес, вода и тишина.
                </p>
                <p>
                  Мы не сдаем отдельные комнаты и не подселяем вторую компанию. Весь дом остается
          ...
          <div data-reveal className="grid gap-8 min-[390px]:gap-10 lg:grid-cols-[1fr_1fr] lg:gap-24">
            <div className="flex flex-col gap-8">
              <SectionHeading
                ...
                lead="Все необходимое для спокойного отдыха без доплат и скрытых условий."
              />

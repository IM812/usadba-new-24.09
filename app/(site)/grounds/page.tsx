...
const dayPlan = [
  ...
  {
    part: "Ночь",
    text: "Тихий сосновый лес, звёздное небо и отдых вдали от городского шума.",
  },
]
  ...
  return (
    <>
      <PageHero
        ...
        lead="Усадьба находится между двумя озёрами, в окружении соснового леса. Рядом — собственный пляж и причал для спокойного отдыха у воды."
        ...
        <Container size="wide">
          <div data-reveal>
            <SectionHeading
              ...
              lead="Всё это рядом с домом. Лодка и сап-борды доступны за отдельную плату — стоимость уточняется при бронировании."
            />
          </div>
      ...
      <BookingCta
        title="Отдых у двух озёр"
        lead="Скажите даты — уточним стоимость лодки и сап-бордов, расскажем, что сейчас клюёт и где в этом сезоне лучше всего собирать грибы."

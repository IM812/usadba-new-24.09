          ...
          <div data-reveal className="grid gap-12 lg:grid-cols-2 lg:items-center lg:gap-20">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-4 text-pretty text-[15px] leading-relaxed text-muted-foreground">
                <p>
                  Великие Луки в 35 километрах: набережная, музеи, кофейни и рынок с местными продуктами.
                  Хороший вариант для спокойной поездки на полдня, если захочется сменить обстановку.
                </p>
                <p>
                  Для поездки на целый день можно выбрать Ореховно. Мы подскажем маршрут и время
                  выезда, чтобы вы успели вернуться к бане.
                </p>
              </div>

...
export const metadata: Metadata = {
  title: "Отзывы гостей",
  description:
    "Рейтинг 5,0 на основе 41 отзыва. Что пишут гости, которые уже провели несколько дней в усадьбе между двумя озёрами.",
}
...
const themes = [
  ...
  },
  {
    ...
    text: "Гостям запоминаются сосновый лес, озёра рядом с домом и возможность отдохнуть вдали от городского шума.",
  },
]
